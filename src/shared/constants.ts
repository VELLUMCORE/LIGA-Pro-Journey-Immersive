...
export const PrizePool: Record<TierSlug | string, { total: number; distribution: Array<number> }> =
{
  ...
  'iem:event-1': { total: 1_000_000, distribution: [50, 35, 15] },
  'iem:event-2': { total: 1_000_000, distribution: [50, 35, 15] },
  'iem:event-3': { total: 1_250_000, distribution: [50, 35, 15] },
  'iem:event-4': { total: 1_000_000, distribution: [50, 35, 15] },
  'iem:event-5': { total: 1_000_000, distribution: [50, 35, 15] },
