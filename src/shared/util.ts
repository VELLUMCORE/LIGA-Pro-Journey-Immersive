...
const CompetitionLeagueDisplayNameBySlug: Partial<Record<string, string>> = {
  ...
  [Constants.LeagueSlug.ESPORTS_PRO_LEAGUE]: 'Counter-Strike World Circuit',
...
const CompetitionTierDisplayNameBySlug: Partial<Record<string, string>> = {
  ...
  'blast-bounty:spring': 'BLAST Bounty Spring',
  'iem-katowice': 'IEM Katowice',
  'blast-open:spring': 'BLAST Open Spring',
  'blast-rivals:spring': 'BLAST Rivals Spring',
  'pgl-bucharest': 'PGL Bucharest',
  'esports-world-cup': 'Esports World Cup',
  'esl-pro-league:season-23': 'ESL Pro League Season 23',
  'starladder-starseries': 'StarLadder StarSeries',
  'blast-bounty:fall': 'BLAST Bounty Fall',
  'iem-rio': 'IEM Rio',
  'blast-open:fall': 'BLAST Open Fall',
  'blast-rivals:fall': 'BLAST Rivals Fall',
  'thunderpick-world-championship': 'Thunderpick World Championship',
  'cs-asia-championship': 'CS Asia Championships',
...
const CompetitionLogoSlugByTierSlug: Partial<Record<string, string>> = {
  ...
  'blast-bounty:spring': 'blast-bounty',
  'blast-bounty:fall': 'blast-bounty',
  'iem-katowice': 'iem-katowice',
  'blast-open:spring': 'blast-open',
  'blast-open:fall': 'blast-open',
  'blast-rivals:spring': 'blast-rivals',
  'blast-rivals:fall': 'blast-rivals',
  'pgl-bucharest': 'pgl-bucharest',
  'esports-world-cup': 'esports-world-cup',
  'esl-pro-league:season-23': 'esl-pro-league',
  'starladder-starseries': 'starladder-starseries',
  'iem-rio': 'iem-rio',
  'thunderpick-world-championship': 'thunderpick-world-championship',
  'cs-asia-championship': 'cs-asia-championship',
};
